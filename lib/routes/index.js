...
router.get('/', function(req, res) {
	...
	apiActions.getUserInfo(userCollection, userId, function(user) {
...
router.get('/recipe/:query', function(req, res) {
	...
	apiActions.getUserInfo(userCollection, userId, function(user) {
		...
		apiActions.getDocumentByTitle(recipeCollection, 'j:"' + req.cookies.cookinguser + '"', query, function(docs) {
			res.render('recipe', {
				title: 'Recipe',
...
router.post('/login', function(req, res) {
	...
	apiActions.getUserID(userCollection, req.body.username, function(id) {
...
router.post('/register', function(req, res) {
	...
	apiActions.registerUser(userCollection, userDetails, function(userDetails) {
		apiActions.getUserID(userCollection, userDetails.username, function(id) {
			res.cookie('cookinguser', id);
			res.status(200).send()
		})
	});
